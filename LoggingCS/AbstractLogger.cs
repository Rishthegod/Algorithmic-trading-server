...
namespace TradingEngineServer.Logging
{
	...
	{ //implement AbstractLogger that inherits from ILogger
        protected AbstractLogger()
        {
            //create a protected constructor for AbstractLogger
        }

        public void Debug(string module, string message) => Log(LogLevel.Debug, module, message);
        
        public void Debug(string module, Exception exception) => Log(LogLevel.Debug, module, $"{exception}"); //string interpolation turns the error mesage to a string
